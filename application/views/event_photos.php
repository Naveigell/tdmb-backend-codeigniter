  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="kt-form" id="form-partner" action="<?php echo base_url('add-event-photo')?>" method="post" enctype="multipart/form-data">
...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php echo $product->event_name;?></h5>
            <!--end::Page Title-->
            <!--end::Actions-->
        </div>
        <!--end::Info-->
        ...
        var demo = function() {
            ...
            var datatable = $('#kt_datatable').KTDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: '<?php echo base_url('event-photos-list/') ?><?php echo $product->event_id?>',
                            map: function(raw) {
                                // sample data mapping
                                var dataSet = raw;
                ...
                columns: [
					{
                        ...
                        template: function(row){
                            return '<img width="50" src="<?php echo base_url('assets/img/event/');?>'+row.det_pic+'">';
                        }
                    },{
                        field: 'det_title',
                        title: 'Name'
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result) {
                            $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url('delete-event-photos') ?>',
                                data: {
                                    det_id: id,
                                },
                                dataType: 'json',
